...
<div class="container">
	...
	<div class="jumbotron mt-4 mb-sm-4" style="margin-bottom: 0">
	  <h1 class="display-4">VIT Previous Year Question Papers</h1>
	  <p class="lead">A Reliable Source for Students of VIT to prepare for Exams.</p>
	  <hr class="my-4">
	...
	<div class="book-card row">
		<?php if ($books): ?>
				...
				<div class="col-md-4 mb-sm-4 mt-c-sm-3">
					<div class="card">
					  ...
					  <div class="card-body">
					    ...
					    <p class="card-text"><?php echo $book['pdesc'] ?></p><a href="https://drive.google.com/drive/folders/1MJd8Z92MESJXvK-z0xjwb21u0L1Ft6g6?usp=sharing">Demo</a>
			...
			<?php else: ?>
				<div class="p-5">
					<p class="text-center">No Course found for your search</p>
				</div>
		<?php endif ?>
	</div>
</div>
